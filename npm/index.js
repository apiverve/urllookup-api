...
class urllookupWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/urllookup');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/urllookup';
    }
        ...
        if (requiredParams.length > 0) {
            for (var i = 0; i < requiredParams.length; i++) {
                if (!query[requiredParams[i]]) {
                    throw new Error(`Required parameter [${requiredParams[i]}] is missing. See documentation: https://docs.apiverve.com/ref/urllookup`);
                }
            }
        }
...
module.exports = urllookupWrapper;
