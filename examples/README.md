# URL Lookup API - Examples

This folder contains example code for using the URL Lookup API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/urllookup',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/urllookup");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/urllookup](https://docs.apiverve.com/ref/urllookup)
