...
```gradle
dependencies {
    implementation 'com.github.apiverve:urllookup-api:1.1.14'
}
```
...
```java
import com.apiverve.urllookup.URLLookupAPIClient;
import com.apiverve.urllookup.APIResponse;
import com.apiverve.urllookup.APIException;

// Initialize the client
URLLookupAPIClient client = new URLLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("url", "https://www.merriam-webster.com/dictionary/documentation");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/urllookup](https://docs.apiverve.com/ref/urllookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/urllookup](https://docs.apiverve.com/ref/urllookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/urllookup-api/issues)
